 ...
 * @base: base of number representative used by buffer
 *
...
/**
 * fill_numbase_buff - fills buffer with cirrect numbers up to base 36
 * @num: number to convert to string given base
 * @base: base of number used in conversin, only works up to base 36
